          ...
          <form method="post" action="register">
            ...
            <div class="form-group">
              ...
              <div class="input-group mb-3">
                ...
                <input id="password-confirm" type="password" class="form-control" placeholder="Password" name="confirm_pass">
              </div>
            </div>
            <div class="form-group">
            ...
            <div class="form-group">
              <p>Already have an account? <a href="/lab5/login">Login now!</a></p>
            </div>
            </div>
          </form>
          <p>${error}</p>
